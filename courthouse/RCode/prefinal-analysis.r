...
with(att, plot(q_grade, tardy, col="orange", pch=16,
	 xlab="Grade Level", ylab="Monthly Tardy Marks",
	 main="Monthly Tardy Distributions by Grade"))
	 
tardy.aov.grade <- aov(tardy ~ q_grade, data=att)
model.tables(tardy.aov.grade, "means")
summary(tardy.aov.grade)

with(att, plot(q_grade, absent, col="orange", pch=16,
	 xlab="Grade Level", ylab="Monthly Absent Marks",
	 main="Monthly Absences Distributions by Grade"))

absent.aov.grade <- aov(absent ~ q_grade, data=att)
model.tables(absent.aov.grade, "means")
summary(absent.aov.grade)
	 
with(att, plot(q_grade, suspend, col="orange", pch=16,
	 xlab="Grade Level", ylab="Monthly Suspension Marks",
	 main="Monthly Suspensions Distributions by Grade"))
...
with(att, plot(condition_id, tardy, col="orange", pch=16,
	 xlab="Condition ID", ylab="Monthly Tardy Marks",
	 main="Monthly Tardy Distributions by Condition"))
	 
tardy.aov.grade <- aov(tardy ~ condition_id, data=att)
model.tables(tardy.aov.grade, "means")
summary(tardy.aov.grade)

with(att, plot(condition_id, absent, col="orange", pch=16,
	 xlab="Condition ID", ylab="Monthly Absent Marks",
	 main="Monthly Absences Distributions by Condition"))

absent.aov.grade <- aov(absent ~ condition_id, data=att)
model.tables(absent.aov.grade, "means")
summary(absent.aov.grade)
	 
with(att, plot(condition_id, suspend, col="orange", pch=16,
	 xlab="Condition ID", ylab="Monthly Suspension Marks",
	 main="Monthly Suspensions Distributions by Condition"))
	 
suspend.aov.grade <- aov(suspend ~ condition_id, data=att)
model.tables(suspend.aov.grade, "means")
summary(suspend.aov.grade)
