% ------- This is a set of optimized logic rules from Copi et al., 14th ed. ----------
...
% ---------Equivalences as Rules (for performance) --------
% -- Commutative Rules (2-level)
rule([[P, +, Q]], [Q, +, P], comm).
rule([[[P, +, Q], O, R]], [[Q, +, P], O, R], comm).
rule([[R, O, [P, +, Q]]], [R, O, [Q, +, P]], comm).
rule([[P, *, Q]], [Q, *, P], comm).
rule([[[P, *, Q], O, R]], [[Q, *, P], O, R], comm).
rule([[R, O, [P, *, Q]]], [R, O, [Q, *, P]], comm).
...
% -- Demorgan rules (2-level)
rule([[~, [P, *, Q]]], [[~, P], +, [~, Q]], demorgan).
rule([[[~, P], +, [~, Q]]], [~, [P, *, Q]], demorgan).
rule([[[~, [P, *, Q]], O, R]], [[[~, P], +, [~, Q]], O, R], demorgan).
rule([[[[~, P], +, [~, Q]], O, R]], [[~, [P, *, Q]], O, R], demorgan).
...
% -- Material Implication Rules (2-level)
rule([[P, ->, Q]], [[~, P], +, Q], mimp).
rule([[[~, P], +, Q]], [P, ->, Q], mimp).
rule([[[P, ->, Q], O, R]], [[[~, P], +, Q], O, R], mimp).
rule([[[[~, P], +, Q], O, R]], [[P, ->, Q], O, R], mimp).
rule([[R, O, [P, ->, Q]]], [R, O, [[~, P], +, Q]], mimp).
rule([[R, O, [[~, P], +, Q]]], [R, O, [P, ->, Q]], mimp).
